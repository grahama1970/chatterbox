...
def main() -> int:
    ...
    listener_python = Path("/home/graham/workspace/experiments/RealtimeSTT/.venv-fastapi/bin/python")
    parser.add_argument("--realtimestt-python", default=listener_python, type=Path)
    parser.add_argument("--rung7-python", default=listener_python, type=Path)
