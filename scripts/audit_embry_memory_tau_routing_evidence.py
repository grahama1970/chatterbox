...
DEFAULT_PROOFS = [
    Path("/tmp/chatterbox-fork-agent-out/embry-memory-answerability-ledger/20260708T075749Z-memory-answerability-ledger/receipt.json"),
    ...
    Path("/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260708T080421Z-medium-sparta-qra-after-scope-fix/receipt.json"),
    Path("/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260708T080421Z-medium-persona-recall-after-scope-fix/receipt.json"),
    Path("/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260708T080421Z-medium-persona-miss-after-scope-fix/receipt.json"),
    Path("/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260708T080603Z-advanced-sparta-qra-after-scope-fix/receipt.json"),
    Path("/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260708T080603Z-advanced-persona-recall-after-scope-fix/receipt.json"),
    Path("/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260708T080603Z-advanced-persona-miss-after-scope-fix/receipt.json"),
    Path("/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260708T080738Z-adversarial-sparta-qra-after-scope-fix/receipt.json"),
    Path("/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260708T080738Z-adversarial-persona-recall-after-scope-fix/receipt.json"),
    Path("/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260708T080738Z-adversarial-persona-miss-after-scope-fix/receipt.json"),
    Path("/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260708T080828Z-soak-sparta-qra-after-scope-fix/receipt.json"),
    Path("/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260708T080828Z-soak-persona-recall-after-scope-fix/receipt.json"),
    Path("/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260708T080828Z-soak-persona-miss-after-scope-fix/receipt.json"),
    ...
    Path("/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260708T060000Z-skill-create-evidence-case-simple-live/receipt.json"),
    Path("/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260708T061000Z-skill-create-evidence-case-medium-live/receipt.json"),
    Path("/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260708T061000Z-skill-create-evidence-case-advanced-live/receipt.json"),
    Path("/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260708T061000Z-skill-create-evidence-case-adversarial-live/receipt.json"),
