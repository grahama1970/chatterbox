...
CURRENT_RESULTS: dict[str, dict[str, Any]] = {
    "sparta_qra_compliance-simple-01": {
        "status": "failed",
        "latest_receipt": "/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260707T234201Z-scripted/receipt.json",
        "failed_gates": [
    ...
    "persona_memory_recall-simple-01": {
        "status": "failed",
        "latest_receipt": "/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/20260707T234201Z-scripted/receipt.json",
        "failed_gates": ["persona_memory_answer_wrong_or_unrelated"],
