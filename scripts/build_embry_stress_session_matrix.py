...
_SIMPLE_MEMORY_ANSWERABILITY_RECEIPT = (
    "/tmp/chatterbox-fork-agent-out/embry-memory-answerability-ledger/"
    "20260708T075749Z-memory-answerability-ledger/receipt.json"
)
...
CURRENT_RESULTS: dict[str, dict[str, Any]] = {
    "sparta_qra_compliance-simple-01": {
        "status": "passed",
        "latest_receipt": _SIMPLE_MEMORY_ANSWERABILITY_RECEIPT,
        "failed_gates": [],
        "observed": "Live /answer used scoped SPARTA QRA evidence and included QRA/evidence/acceptable terms without S0609 leakage.",
    },
    "sparta_qra_compliance-simple-02": {
        "status": "passed",
        "latest_receipt": _SIMPLE_MEMORY_ANSWERABILITY_RECEIPT,
        "failed_gates": [],
        "observed": "Live /answer no longer returned the deprecated-control terminal exclusion for mandatory QRA evidence fields.",
    },
    "sparta_qra_compliance-simple-03": {
        "status": "passed",
        "latest_receipt": _SIMPLE_MEMORY_ANSWERABILITY_RECEIPT,
        "failed_gates": [],
        "observed": "Live /answer evidence trail did not carry deprecated/non-generation control leakage for the simple QRA prompt.",
    },
    "sparta_qra_compliance-simple-04": {
        "status": "passed",
        "latest_receipt": _SIMPLE_MEMORY_ANSWERABILITY_RECEIPT,
        "failed_gates": [],
        "observed": "Live /answer no longer returned the deprecated-control terminal exclusion for weak-evidence handling.",
    },
    "persona_memory_recall-simple-01": {
        "status": "passed",
        "latest_receipt": _SIMPLE_MEMORY_ANSWERABILITY_RECEIPT,
        "failed_gates": [],
        "observed": "Live /answer returned Horus Lupercal grew up on Cthonia from persona_memory.",
    },
    "persona_memory_recall-simple-02": {
        "status": "passed",
        "latest_receipt": _SIMPLE_MEMORY_ANSWERABILITY_RECEIPT,
        "failed_gates": [],
        "observed": "Live /answer restricted persona recall to persona_memory instead of unrelated source collections.",
    },
    "persona_memory_recall-simple-03": {
        "status": "passed",
        "latest_receipt": _SIMPLE_MEMORY_ANSWERABILITY_RECEIPT,
        "failed_gates": [],
        "observed": "Live /answer restricted Horus persona recall to persona_memory instead of TTS skill descriptions.",
    },
    "persona_memory_recall-simple-04": {
        "status": "passed",
        "latest_receipt": _SIMPLE_MEMORY_ANSWERABILITY_RECEIPT,
        "failed_gates": [],
        "observed": "Live /answer did not use unrelated source collections for the QRA-caching persona memory prompt.",
    },
    "persona_memory_miss-simple-01": {
        "status": "passed",
        "latest_receipt": _SIMPLE_MEMORY_ANSWERABILITY_RECEIPT,
        "failed_gates": [],
        "observed": "Live /answer returned insufficient_memory_evidence with no sources for the unrecorded private-code-word prompt.",
    },
    "persona_memory_miss-simple-02": {
        "status": "passed",
        "latest_receipt": _SIMPLE_MEMORY_ANSWERABILITY_RECEIPT,
        "failed_gates": [],
        "observed": "Live /answer returned insufficient_memory_evidence with no sources for the unrecorded nickname prompt.",
    },
    "persona_memory_miss-simple-03": {
        "status": "passed",
        "latest_receipt": _SIMPLE_MEMORY_ANSWERABILITY_RECEIPT,
        "failed_gates": [],
        "observed": "Live /answer returned insufficient_memory_evidence with no sources for the undocumented-promise prompt.",
    },
    "persona_memory_miss-simple-04": {
        "status": "passed",
        "latest_receipt": _SIMPLE_MEMORY_ANSWERABILITY_RECEIPT,
        "failed_gates": [],
        "observed": "Live /answer returned insufficient_memory_evidence with no sources for the unrecorded factory-phrase prompt.",
    },
...
_ADVERSARIAL_MEMORY_FAILURES = {
    "sparta_qra_compliance-adversarial-01": [
        "sparta_qra_answer_missing_acceptance_terms",
        "sparta_qra_answer_overfit_to_unrelated_control_exclusion",
    ],
    "sparta_qra_compliance-adversarial-02": ["sparta_qra_answer_overfit_to_unrelated_control_exclusion"],
    "sparta_qra_compliance-adversarial-03": ["sparta_qra_answer_overfit_to_unrelated_control_exclusion"],
    "sparta_qra_compliance-adversarial-04": ["sparta_qra_answer_overfit_to_unrelated_control_exclusion"],
    "persona_memory_recall-adversarial-01": [
        "persona_memory_answer_uses_unrelated_source_collection",
        "persona_memory_answer_wrong_or_unrelated",
    ],
    "persona_memory_recall-adversarial-02": ["persona_memory_answer_uses_unrelated_source_collection"],
    "persona_memory_recall-adversarial-03": ["persona_memory_answer_uses_unrelated_source_collection"],
    "persona_memory_recall-adversarial-04": ["persona_memory_answer_uses_unrelated_source_collection"],
    "persona_memory_miss-adversarial-01": ["memory_miss_should_not_answer_unrelated_record"],
    "persona_memory_miss-adversarial-02": ["memory_miss_should_not_answer_unrelated_record"],
    "persona_memory_miss-adversarial-03": ["memory_miss_should_not_answer_unrelated_record"],
    "persona_memory_miss-adversarial-04": ["memory_miss_should_not_answer_unrelated_record"],
}
...
for _index in range(1, 5):
    CURRENT_RESULTS[f"brave_research-adversarial-{_index:02d}"] = {
        "status": "passed",
...
_ADVERSARIAL_TAU_SKILL_RECEIPT = (
    "/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/"
    "20260708T022326Z-matrix-adversarial-routes-16-31/receipt.json"
)

for _index in range(1, 5):
    CURRENT_RESULTS[f"tau_tool_orchestration-adversarial-{_index:02d}"] = {
        "status": "failed",
        "latest_receipt": _ADVERSARIAL_TAU_SKILL_RECEIPT,
        "failed_gates": ["tau_agent_handoff_not_exercised"],
        "observed": (
            "Live adversarial Tau preflight reached the Tau wrapper, but no tau.agent_handoff.v1 "
            "work order or DAG receipt was created."
        ),
    }
...
for _folder_id in ["skill_create_evidence_case", "skill_create_figure", "skill_analytics"]:
    for _index in range(1, 5):
        CURRENT_RESULTS[f"{_folder_id}-adversarial-{_index:02d}"] = {
            "status": "failed",
            "latest_receipt": _ADVERSARIAL_TAU_SKILL_RECEIPT,
            "failed_gates": [
                "tau_agent_handoff_not_exercised",
            ...
            "observed": (
                "Live adversarial direct-skill preflight reached Tau and found the required skill, "
                "but no Tau handoff, DAG, or skill-call receipt was emitted."
            ),
        }

_SOAK_TAU_SKILL_RECEIPT = (
    "/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/"
    "20260708T024031Z-matrix-soak-routes-16-31/receipt.json"
)

for _index in range(1, 5):
    CURRENT_RESULTS[f"tau_tool_orchestration-soak-{_index:02d}"] = {
        "status": "failed",
        "latest_receipt": _SOAK_TAU_SKILL_RECEIPT,
        "failed_gates": ["tau_agent_handoff_not_exercised"],
        "observed": (
            "Live soak Tau preflight reached the Tau wrapper, but no tau.agent_handoff.v1 "
            "work order or DAG receipt was created."
        ),
    }
...
for _folder_id in ["skill_create_evidence_case", "skill_create_figure", "skill_analytics"]:
    for _index in range(1, 5):
        CURRENT_RESULTS[f"{_folder_id}-soak-{_index:02d}"] = {
            "status": "failed",
            "latest_receipt": _SOAK_TAU_SKILL_RECEIPT,
            "failed_gates": [
                "tau_agent_handoff_not_exercised",
            ...
            "observed": (
                "Live soak direct-skill preflight reached Tau and found the required skill, "
                "but no Tau handoff, DAG, or skill-call receipt was emitted."
            ),
        }
...
_ADVERSARIAL_ROUTES_32_47_RECEIPT = (
    "/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/"
...
_ADVANCED_ROUTES_48_63_RECEIPT = (
    "/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/"
    "20260708T021302Z-matrix-advanced-routes-48-63/receipt.json"
)

for _index in range(1, 5):
    CURRENT_RESULTS[f"speaker_identity-advanced-{_index:02d}"] = {
        "status": "passed",
        "latest_receipt": _ADVANCED_ROUTES_48_63_RECEIPT,
        "failed_gates": [],
        "observed": (
            "Live advanced speaker-resolution policy case passed through memory /speaker/resolve "
            "using deterministic speaker evidence."
        ),
    }
...
_SOAK_ROUTES_48_63_RECEIPT = (
    "/tmp/chatterbox-fork-agent-out/embry-intelligence-stress/"
    "20260708T024716Z-matrix-soak-routes-48-63/receipt.json"
)

for _index in range(1, 5):
    CURRENT_RESULTS[f"speaker_identity-soak-{_index:02d}"] = {
        "status": "passed",
        "latest_receipt": _SOAK_ROUTES_48_63_RECEIPT,
        "failed_gates": [],
        "observed": (
            "Live soak speaker-resolution policy case passed through memory /speaker/resolve "
            "using deterministic speaker evidence."
        ),
    }
...
CURRENT_RESULTS.update(
    {
        "tone_emotion-soak-01": {
            "status": "passed",
            "latest_receipt": _SOAK_ROUTES_48_63_RECEIPT,
            "failed_gates": [],
            "observed": "Memory /intent returned an acceptable voice_delivery tone for a frustrated/warm de-escalation prompt.",
        },
        "tone_emotion-soak-02": {
            "status": "failed",
            "latest_receipt": _SOAK_ROUTES_48_63_RECEIPT,
            "failed_gates": ["voice_delivery_tone_expected_deflect_calm_or_firm_boundary_or_playful_light"],
            "observed": "Memory /intent returned an unacceptable tone for hostile input; expected deflect_calm, firm_boundary, or playful_light.",
        },
        "tone_emotion-soak-03": {
            "status": "failed",
            "latest_receipt": _SOAK_ROUTES_48_63_RECEIPT,
            "failed_gates": ["voice_delivery_tone_expected_calm_precise_or_careful_concerned_or_neutral_warm_or_relieved"],
            "observed": "Memory /intent returned an unacceptable tone for discouraged input; expected a careful, neutral-warm, or relieved support tone.",
        },
        "tone_emotion-soak-04": {
            "status": "failed",
            "latest_receipt": _SOAK_ROUTES_48_63_RECEIPT,
            "failed_gates": ["voice_delivery_tone_expected_firm_boundary_or_one_at_a_time_interrupt"],
            "observed": "Memory /intent returned an unacceptable tone for speaker overlap; expected one_at_a_time_interrupt or firm_boundary.",
